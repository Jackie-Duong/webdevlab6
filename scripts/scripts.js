...
function recalculate() {
    ...
    var totalCost;
    if (modelName.innerHTML === "Model XYZ") totalCost = duration * 100;
    else totalCost = duration * 213;
...
function changeModel() {
    ...
    if (modelText.innerHTML === "Model XYZ") modelText.innerHTML = "Model CPRG";
    else modelText.innerHTML = "Model XYZ";
    recalculate();
}
